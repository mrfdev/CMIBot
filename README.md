...
`runtime-exporter/compatibility.json` is the source of truth for the internal Paper tooling. It currently pins Paper `26.2` build `124` on `STABLE`, API `26.2.build.124-stable`, exporter `1.0.1`, and Java target `25`.
