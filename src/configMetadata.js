...
const environmentSections = [
  ...
  },
  {
    ...
    variables: [
      ...
      variable("INTERACTION_USER_RATE_LIMIT", "Autocomplete and result-control interactions allowed per user in each rate window.", { type: "integer", defaultValue: "20" }),
      variable("INTERACTION_CHANNEL_RATE_LIMIT", "Authorized autocomplete and result-control interactions allowed per channel in each rate window.", { type: "integer", defaultValue: "100" }),
      variable("INTERACTION_GLOBAL_RATE_LIMIT", "Authorized autocomplete and result-control interactions allowed globally in each rate window.", { type: "integer", defaultValue: "200" }),
      variable("INTERACTION_RATE_WINDOW_SECONDS", "Sliding autocomplete and result-control rate window in seconds.", { type: "integer", defaultValue: "10" }),
      variable("INTERACTION_MAX_CONCURRENT", "Maximum concurrent authorized autocomplete and result-control interactions.", { type: "integer", defaultValue: "8" }),
